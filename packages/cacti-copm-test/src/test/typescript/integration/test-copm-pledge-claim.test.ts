...
describe("Copm Pledge and Claim", () => {
  ...
  test.each(networksToTest)(
    ...
    async (net1Type, net2Type) => {
      ...
      expect((pledgeNFTResult as any).pledgeId).toBeString();
        ...
        .claimPledgedAssetV1(
          new ClaimPledgedAssetV1Request({
            assetPledgeClaimV1PB: {
              pledgeId: (pledgeNFTResult as any).pledgeId,
              asset: {
                assetType: assetType,
                assetId: pledgeAssetName,
              },
  ...
  test.each(networksToTest)(
    ...
    async (net1Type, net2Type) => {
      ...
      expect((pledgeResult as any).pledgeId).toBeString();
      ...
      const claimResult = await copmTester
        ...
        .claimPledgedAssetV1(
          new ClaimPledgedAssetV1Request({
            assetPledgeClaimV1PB: {
              pledgeId: (pledgeResult as any).pledgeId,
              asset: {
                assetType: assetType,
                assetQuantity: exchangeQuantity,
              },
